package ru.ijo42.dka.models.head.class4;
...
public class DKPH2 extends ArmorBaseModel {

    public DKPH2() {
        super(256, 256, Armor.getResourceLocation("textures/models/head/dkph2.png"));
    }
